        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-slate-800">
            {testCases.map((testCase) => (
              <tr key={testCase.id} className="hover:bg-slate-50 dark:bg-slate-800/30 transition-colors">
                <td className="py-4 px-6">
                  <div>
                    <div className="text-sm font-medium text-slate-900 dark:text-white">{testCase.testRunId}</div>
