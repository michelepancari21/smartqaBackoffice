...
const CreateSharedStepModal: React.FC<CreateSharedStepModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting
}) => {
  // Form state - Suppression du champ description
  ...
  return (
    <Modal 
      isOpen={isOpen} 
      onClose={onClose} 
      title="Create New Shared Step"
      size="custom"
    >
      <div className="h-[calc(95vh-8rem)] flex flex-col">
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          {/* Main Content avec padding équilibré */}
...
export default CreateSharedStepModal;