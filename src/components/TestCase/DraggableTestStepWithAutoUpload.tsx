...
interface DraggableTestStepWithAutoUploadProps {
  step: TestStep;
  index: number;
...
const DraggableTestStepWithAutoUpload: React.FC<DraggableTestStepWithAutoUploadProps> = ({
  step,
  index,
  onUpdate,
  onRemove,
...
export default DraggableTestStepWithAutoUpload;