    ...
    >
      <div className="relative">
        ...
        <div className="text-center mb-4 pr-10">
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-1">Edit Test Plan</h2>
          <p className="text-sm text-slate-500 dark:text-gray-400">Update your testing strategy and timeline</p>
        </div>
