  ...
  return (
    <div className="fixed inset-0 z-[200] overflow-hidden">
      ...
      <div className="absolute inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-2xl flex items-center justify-center">
        <div className="relative w-full bg-slate-800 rounded-lg border border-slate-600 shadow-2xl flex flex-col max-h-[90vh]">
          <div className="flex items-center justify-between p-4 border-b border-slate-700">
            <div>
              <h3 className="text-lg font-semibold text-white">Add Result</h3>
              <p className="text-sm text-gray-400 mt-1 truncate">{testCaseTitle}</p>
            </div>
            <button
          ...
          <div className="flex justify-end space-x-3 p-4 border-t border-slate-700 bg-slate-800/50">
            <Button
              variant="secondary"
              onClick={handleCancel}
            >
